...
<input
    ...
    bind:this={input}
    autocorrect="off"
    class="block w-full px-3 bg-transparent border-neutral-600
	h-full box-border border-2 rounded-md text-xl outline-none focus:border-teal-500
	focus:outline-3 focus:outline-offset-0 focus: focus:outline-teal-950 transition"
